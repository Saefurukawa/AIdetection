...
import { input, loadGraphModel } from '@tensorflow/tfjs';
 ...
 // Get the plain text content of the email body
  item.body.getAsync(Office.CoercionType.Text, (result) => {
    if (result.status === Office.AsyncResultStatus.Succeeded) {
      ...
      // Now you have the plain text content of the email
      // You can pass this emailContent to your preprocess function
      const inputFeatures = preprocess(emailContent);
